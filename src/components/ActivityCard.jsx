...
export default function ActivityCard({ activity }){
    return(
        <Link href={`/aktiviteter/${activity.id}`}>
            <div className="relative text-[#EAEAEA] mb-6">
                <img loading="lazy" className="rounded-t-[2rem] rounded-l-[2rem] h-[20rem] w-full object-cover" alt="produkt billede" src={activity.asset.url}/>
