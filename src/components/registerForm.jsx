...
<span className="text-red-500 bg-[#00000085] rounded flex justify-center">{formState?.errors?.age?._errors[0]}</span>
        ...
        <button type="submit" className="block text-[#EAEAEA] bg-[#5E2E53] rounded-lg w-[13rem] flex justify-center items-center h-[3rem]" > Registrere bruger </button>
        <Link href="/login" className="block text-[#EAEAEA] bg-[#5E2E53] rounded-lg w-[13rem] flex justify-center items-center h-[3rem] my-2">Tilbage til login</Link>
